    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startmovehour', models.PositiveIntegerField()),
                ('startplace', models.PositiveIntegerField()),
                ...
                ('passenger', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.passenger')),
            ],
        ),
        migrations.CreateModel(
            name='Route',
